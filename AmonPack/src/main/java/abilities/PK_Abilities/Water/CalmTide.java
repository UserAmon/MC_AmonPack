...
public class CalmTide extends HealingAbility implements AddonAbility {
	...
	public CalmTide(Player player) {
		super(player);
		this.cooldown = AmonPackPlugin.getAbilitiesConfig().getLong("AmonPack.Water.CalmTide.Cooldown", 8000L);
		this.range = AmonPackPlugin.getAbilitiesConfig().getDouble("AmonPack.Water.CalmTide.Range", 15.0);
		this.healingDuration = AmonPackPlugin.getAbilitiesConfig().getInt("AmonPack.Water.CalmTide.HealingDuration", 120);
		this.healingInterval = AmonPackPlugin.getAbilitiesConfig().getInt("AmonPack.Water.CalmTide.HealingInterval", 10);
		this.healingAmount = AmonPackPlugin.getAbilitiesConfig().getDouble("AmonPack.Water.CalmTide.HealingAmount", 1.0);
		this.speedAmplifier = AmonPackPlugin.getAbilitiesConfig().getInt("AmonPack.Water.CalmTide.SpeedAmplifier", 1);
		this.speedDuration = AmonPackPlugin.getAbilitiesConfig().getInt("AmonPack.Water.CalmTide.SpeedDuration", 100);
	...
	public void progress() {
		...
		if (state == 1) {
			...
			double progressRatio = (double) healingTicks / (double) this.healingDuration;
			...
			if (healingTicks >= this.healingDuration) {
				player.addPotionEffect(new PotionEffect(PotionEffectType.SPEED, this.speedDuration, this.speedAmplifier));
	...
	public long getCooldown() {
		return AmonPackPlugin.getAbilitiesConfig().getLong("AmonPack.Water.CalmTide.Cooldown", 8000L);
	}
