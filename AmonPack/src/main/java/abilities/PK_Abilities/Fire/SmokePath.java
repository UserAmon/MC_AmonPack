...
public class SmokePath extends SmokeAbility implements AddonAbility {
	...
	public String getDescription() {
		return "This ability creates smoke clouds! Throw a dangerous path of smoke that allows you to travel rapidly between locations.";
	}

	@Override
	public String getInstructions() {
		return "Left-click to throw a path of smoke.";
	}
