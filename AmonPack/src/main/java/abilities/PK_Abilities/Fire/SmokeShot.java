...
public class SmokeShot extends SmokeAbility implements AddonAbility {
	...
	public String getDescription() {
		return "This ability uses smoke source! Allows you to manipulate nearby smoke clouds by throwing them at targeted location, damaging oponents on contact.";
	}

	@Override
	public String getInstructions() {
		return "Sneak to select smoke cloud. Left-click to fire it.";
	}
