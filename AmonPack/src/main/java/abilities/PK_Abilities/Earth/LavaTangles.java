        ...
        if (state == State.GROWING) {
            ...
            if (desiredHeight > currentHeight) {
                ...
                if (b.getType() == Material.AIR) {
                    columnTempBlocks.add(new TempBlock(b, Material.LAVA.createBlockData(), 300));
                    b.getWorld().playSound(b.getLocation(), Sound.BLOCK_LAVA_AMBIENT, 0.5f, 1.2f);
                }
            }
            ...
            originLoc.getWorld().spawnParticle(Particle.LAVA, originLoc.clone().add(0, targetHeight, 0), 1, 0.1, 0.1, 0.1, 0.01);
        }
    }
