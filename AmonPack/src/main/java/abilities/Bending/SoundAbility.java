                        ...
                        if (entity != null) {
                            if (entity.isDead()) {
                                ...
                                if (time > 0) {
                                    ...
                                    if (applier != null) {
                                        RPG.Levels.BendingTree.PlayerBendingBranch branch = (AmonPackPlugin.levelsBending != null) ? AmonPackPlugin.levelsBending.GetBranchByPlayerName(applier.getName()) : null;
