...
import static Abilities.Bending.SoundAbility.AfffectedEntities;
...
public class MagicEffects {
    ...
    public double ExecuteOnUse(Player player) {
        if (id.startsWith("Summon_Boss_")) {
            ...
            StartRitual(location, () -> Plugin.BossScrollManager.getInstance().summonBoss(location, bossId));
    ...
    private void IceThorns(Location startLoc, Player player) {
        ...
        }.runTaskTimer(Plugin.AmonPackPlugin.plugin, 0L, 1L);
    }
