...
public class MagicEffects {
    ...
    public MagicEffects(List<MagicEffectsConditions> conditions, List<ItemStack> cost, String name, List<String> lore, String id, boolean isMajor) {
        ...
        double DamageBoosts = 0;
            switch (id){
                ...
                case "Minor_Air_Sound_Damage_Buff":
                    if(AfffectedEntities!=null&& !AfffectedEntities.keySet().isEmpty()&& AfffectedEntities.containsKey(victim)){
                        DamageBoosts=DamageBoosts+1;
                    }
                    break;
                ...
                case "Lightning_Aspect":
                    ...
                    //player.setVelocity(player.getLocation().getDirection().add(new Vector(0,0.4,0)).multiply(1));
